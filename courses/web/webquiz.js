...
const end = () => {
  ...
  <h3 id="name"></h3>
    <h4> Your Score is :${right} / ${total} are correct</h4>
    <h5> Quiz is Ended </h5>
    <a href = 'Web Development.html'> <button id="res" class='btn'>Exit </button> </a>
    `;
  document.getElementById("name").innerHTML = localStorage.getItem("nameC");
};
